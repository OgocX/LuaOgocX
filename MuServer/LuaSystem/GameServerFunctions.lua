...
function GameServerFunctions.PlayerDropItem(callback, ...)
	PlayerDropItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.CharacterSet(callback, ...)
	CharacterSet_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.MonsterDie(callback, ...)
	MonsterDie_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.MonsterDieGiveItem(callback, ...)
	MonsterDieGiveItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerDie(callback, ...)
	PlayerDie_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerSendTrade(callback, ...)
	PlayerSendTrade_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerLevelUp(callback, ...)
	PlayerLevelUp_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.BlockReflet(callback, ...)
	BlockReflet_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerRingEquiped(callback, ...)
	PlayerRingEquiped_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerTradeOk(callback, ...)
	PlayerTradeOk_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerLogout(callback, ...)
	PlayerLogout_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.GuildWarProc(callback, ...)
	GuildWarProc_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.CharacterMove(callback, ...)
	CharacterMove_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerMove(callback, ...)
	PlayerMove_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.RunningSkill(callback, ...)
	RunningSkill_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.NpcTalk(callback, ...)
	NpcTalk_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerSellItem(callback, ...)
	PlayerSellItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerRepairItem(callback, ...)
	PlayerRepairItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerCanMove(callback, ...)
	PlayerCanMove_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerMoveItem(callback, ...)
	PlayerMoveItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerVaultOpen(callback, ...)
	PlayerVaultOpen_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.DeclareWar(callback, ...)
	DeclareWar_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerUseItem(callback, ...)
	PlayerUseItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerVaultClose(callback, ...)
	PlayerVaultClose_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerSendTradeX(callback, ...)
	PlayerSendTradeX_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerTradeXOk(callback, ...)
	PlayerTradeXOk_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.CanEquipElementSlot(callback, ...)
	ElementSlot_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerOpenShop(callback, ...)
	PlayerOpenShop_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerCloseShop(callback, ...)
	PlayerCloseShop_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerCanEquipItem(callback, ...)
	PlayerCanEquipItem_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.GameServerProtocol(callback, ...)
	GameServerProtocol_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.MacAddressPlayer(callback, ...)
	MacAddressPlayer_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.PlayerAttackFenrirSkill(callback, ...)
	PlayerAttackFenrirSkill_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.RespawnUser(callback, ...)
	RespawnUser_Handles[callback] = { callback = callback, args = {...} }
end
...
function GameServerFunctions.MonsterReload(callback, ...)
	MonsterReload_Handles[callback] = { callback = callback, args = {...} }
end
