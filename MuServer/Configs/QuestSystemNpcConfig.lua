...
QUEST_SYSTEM_NPC_LOCATION_INFO = {
    { Class = 579, Map = 0, CoordX = 125, CoordY = 125, QuestIdentification = 1},
    { Class = 579, Map = 0, CoordX = 135, CoordY = 135, QuestIdentification = 2},
}
...
QUEST_SYSTEM_NPC_COIN1_CONFIG = { Table = 'MEMB_INFO', Column = 'Cash', Where = 'memb__id' }
QUEST_SYSTEM_NPC_COIN2_CONFIG = { Table = 'CashShopData', Column = 'WCoinC', Where = 'AccountID' }
QUEST_SYSTEM_NPC_COIN3_CONFIG = { Table = 'CashShopData', Column = 'WcoinP', Where = 'AccountID' }
QUEST_SYSTEM_NPC_COIN4_CONFIG = { Table = 'CashShopData', Column = 'GlobinPoint', Where = 'AccountID' }
