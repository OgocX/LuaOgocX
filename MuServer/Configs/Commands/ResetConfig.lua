...
RESET_ACUMULATIVE_LEVEL_AFTER[3] = 15
...
RESET_ACUMULATIVE_RETURN_MAP_CLASS[5] = 0 -- SUM
RESET_ACUMULATIVE_RETURN_MAP_CLASS[6] = 0 -- RF
...
RESET_ACUMULATIVE_RETURN_MAP_X_CLASS[5] = 125 -- SUM
RESET_ACUMULATIVE_RETURN_MAP_X_CLASS[6] = 125 -- RF
...
RESET_ACUMULATIVE_RETURN_MAP_Y_CLASS[5] = 125 -- SUM
RESET_ACUMULATIVE_RETURN_MAP_Y_CLASS[6] = 125 -- RF
RESET_ACUMULATIVE_RELOGAR = {}
RESET_ACUMULATIVE_RELOGAR[0] = 0
RESET_ACUMULATIVE_RELOGAR[1] = 0
RESET_ACUMULATIVE_RELOGAR[2] = 0
RESET_ACUMULATIVE_RELOGAR[3] = 0
